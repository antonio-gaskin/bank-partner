...
func (s *AccountHandlerSuite) SetupTest() {
	...
	s.handler = NewAccountHandler(s.mockService, s.auditLogger, s.metricsCollector, s.northWindService)
...
func (s *AccountHandlerSuite) TestTransfer_Success() {
	...
	// Expect service call
	s.mockService.EXPECT().
		TransferBetweenAccounts(fromAccountID, toAccountID, gomock.Any(), "Transfer to savings", idempotencyKey, gomock.Any(), gomock.Any(), gomock.Any(), s.testUserID).
		DoAndReturn(func(_ uuid.UUID, _ uuid.UUID, amount decimal.Decimal, _ string, _ string, _ string, _ string, _ string, _ uuid.UUID) (*models.Transfer, error) {
...
func (s *AccountHandlerSuite) TestTransfer_SameAccount() {
	...
	s.mockService.EXPECT().
		TransferBetweenAccounts(fromAccountID, fromAccountID, gomock.Any(), "Transfer", idempotencyKey, gomock.Any(), gomock.Any(), gomock.Any(), s.testUserID).
		DoAndReturn(func(_ uuid.UUID, _ uuid.UUID, amount decimal.Decimal, _ string, _ string, _ string, _ string, _ string, _ uuid.UUID) (*models.Transfer, error) {
			if !amount.Equal(decimal.NewFromFloat(100.00)) {
				s.T().Errorf("expected amount 100.00, got %s", amount.String())
			}
...
func (s *AccountHandlerSuite) TestTransfer_WithIdempotencyKey_Success() {
	...
	// Expect service call
	s.mockService.EXPECT().
		TransferBetweenAccounts(fromAccountID, toAccountID, gomock.Any(), "Payment with idempotency", idempotencyKey, gomock.Any(), gomock.Any(), gomock.Any(), s.testUserID).
		DoAndReturn(func(_ uuid.UUID, _ uuid.UUID, amount decimal.Decimal, _ string, _ string, _ string, _ string, _ string, _ uuid.UUID) (*models.Transfer, error) {
...
func (s *AccountHandlerSuite) TestTransfer_DuplicateIdempotencyKey_CompletedTransfer() {
	...
	s.mockService.EXPECT().
		TransferBetweenAccounts(fromAccountID, toAccountID, gomock.Any(), "Duplicate request", idempotencyKey, gomock.Any(), gomock.Any(), gomock.Any(), s.testUserID).
...
func (s *AccountHandlerSuite) TestTransfer_DuplicateIdempotencyKey_PendingTransfer() {
	...
	s.mockService.EXPECT().
		TransferBetweenAccounts(fromAccountID, toAccountID, gomock.Any(), "Pending duplicate", idempotencyKey, gomock.Any(), gomock.Any(), gomock.Any(), s.testUserID).
...
func (s *AccountHandlerSuite) TestTransfer_DuplicateIdempotencyKey_FailedTransfer() {
	...
	s.mockService.EXPECT().
		TransferBetweenAccounts(fromAccountID, toAccountID, gomock.Any(), "Failed duplicate", idempotencyKey, gomock.Any(), gomock.Any(), gomock.Any(), s.testUserID).
