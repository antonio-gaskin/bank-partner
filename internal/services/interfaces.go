...
type NorthWindServiceInterface interface {
	...
	InitiateTransfer(ctx context.Context, transferDto dto.NorthWindInitiateTransferRequest) (*dto.NorthWindTransferStatusResponse, error)
	GetTransferStatus(ctx context.Context, transferID string) (*dto.NorthWindTransferStatusResponse, error)
	ValidateTransfer(
	...
	Notify(data *models.Transfer) error
}
