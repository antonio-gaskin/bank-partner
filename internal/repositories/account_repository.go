...
func (r *accountRepository) ExecuteAtomicTransfer(fromAccountID, toAccountID uuid.UUID, amount decimal.Decimal, fromDescription, toDescription, referenceNumber, status string) (debitTxID, creditTxID uuid.UUID, err error) {
	err = r.db.Transaction(func(tx *gorm.DB) error {
		...
		beforeBalance := fromAcct.Balance
